...
GROUNDING_DINO_INPUTS_DOCSTRING = r"""
    Args:
        ...
        audio_mask (`torch.LongTensor` of shape `(batch_size, height, width)`, *optional*):
        ...
        encoder_outputs (`tuple(tuple(torch.FloatTensor)`, *optional*):
            Tuple consists of (`last_hidden_state_audio`, *optional*: `last_hidden_state_text`, *optional*:
            `audio_hidden_states`, *optional*: `text_hidden_states`, *optional*: `attentions`)
            `last_hidden_state_audio` of shape `(batch_size, sequence_length, hidden_size)`, *optional*) is a sequence
...
class GroundingAudioModel(GroundingAudioPreTrainedModel):
    ...
    def forward(
        ...
        text_outputs = self.text_backbone(input_ids, text_self_attention_masks, token_type_ids, position_ids, return_dict=None)
